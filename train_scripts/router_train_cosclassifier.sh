...
for seed in "${seeds[@]}"; do
    ...
    --save_path "/data/home/chensh/projects/LLM_router/logs/paper_result/CosClassifier/clw_${cluster_loss_weight}/slw_${sample_loss_weight}_clw_${cluster_loss_weight}_${similarity_function}_tk_${top_k}_lk_${last_k}_lr_${learning_rate}_step_${training_steps}_t_${tempreture}_seed_${seed}" \
    --test_data_type "multi_attempt" "multi_attempt" "probability" "probability" "probability" \
    > "./logs/paper_result/CosClassifier/slw_${sample_loss_weight}_clw_${cluster_loss_weight}_${similarity_function}_tk_${top_k}_lk_${last_k}_lr_${learning_rate}_step_${training_steps}_t_${tempreture}_seed_${seed}.log" 2>&1
done
